...
public class LoginFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
		whiteList.add("/idcard/user/fanpalist");
        whiteList.add("/idcard/user/queryFanPaInfoListByPage");
        whiteList.add("/idcard/user/filterfanpalist");
        whiteList.add("/idcard/user/showIdCardImagePageByCardNo");
